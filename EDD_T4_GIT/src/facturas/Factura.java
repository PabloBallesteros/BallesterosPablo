...
/**
 * Permite calcular y presentar la cabecera de una factura.
 * También utiliza la clase <strong><ul>LineaFactura</ul></strong> que permite calcular y presentar las líneas de la factura.
 * 
 * @author Desconocido
 * @version 1.0
 * @see LineaFactura
...
public class Factura {
	...
	/**
	 * 
	 * @param factura1 se pasa como argumento toda la factura y se imprime
	 */
